...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--datapath',default='./data/', type=str, help='Path to dataset')
		...
		self.parser.add_argument('--latents_path', default="data/latents.pt", type=str, help="The latents for the validation")
		...
		self.parser.add_argument('--batch_size', default=40, type=int, help='Batch size for training')
		...
		self.parser.add_argument('--ca_lambda', default=0, type=float, help='ca loss multiplier factor')
		self.parser.add_argument('--id_lambda', default=0, type=float, help='ID loss multiplier factor')
		self.parser.add_argument('--clip_lambda', default=0.1, type=float, help='CLIP loss multiplier factor')
		self.parser.add_argument('--latent_l2_lambda', default=10.0, type=float, help='Latent L2 loss multiplier factor')
		self.parser.add_argument('--recon_lambda', default=0, type=float,
								 help='reconstruction loss multiplier factor')
		self.parser.add_argument('--rel_lambda', default=0, type=float,
								 help='distance_consistence loss multiplier factor')		
		self.parser.add_argument('--kl_lambda', default=1, type=float, help='kl loss multiplier factor')

		self.parser.add_argument('--stylegan_weights', default='../models/ffhq.pkl', type=str, help='Path to StyleGAN model weights')
